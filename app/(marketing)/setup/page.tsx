// /setup — account activation page for directly-created users.
// Admin creates the user → wizard shows a setup link → user visits this page
// → sets their password → redirected to /login.
import type { Metadata } from 'next'
import Image from 'next/image'
import { SetupContent } from './SetupContent'

export const metadata: Metadata = { title: 'Activate Your Account — LegacyLink' }
    ...
    <div className="relative min-h-screen flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="px-8 py-8 bg-brand-dark">
          ...
          <SetupContent initialToken={token ?? ''} />
        </div>
      </div>
