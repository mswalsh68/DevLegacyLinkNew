      ...
      renderMetrics={(raw) => {
        ...
        return (
          <div style={{ display: 'flex', gap: 16, marginBottom: 28, flexWrap: 'wrap' }}>
            <MetricCard label="Alumni Interactions" total={m.totalInteractions}      monthValue={m.monthInteractions}  />
            <MetricCard label="Alumni Emails Sent"  total={m.alumniEmailsTotal}      monthValue={m.alumniEmailsMonth}  />
            <MetricCard label="Alumni Logins"       total={m.alumniLoginsLast30Days} monthLabel="in last 30 days"      />
            <MetricCard label="Player Emails Sent"  total={m.playerEmailsTotal}      monthValue={m.playerEmailsMonth}  />
