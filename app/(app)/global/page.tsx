...
import { sp_GetTeams } from '@/lib/db/procedures'
...
export default async function GlobalPage() {
  ...
  const rawTeams = await sp_GetTeams()
  const teams = (rawTeams as unknown as Array<Record<string, unknown>>).map(t => ({
    id:   t.id   as number,
